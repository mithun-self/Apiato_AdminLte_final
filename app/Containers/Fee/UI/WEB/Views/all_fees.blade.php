              ...
              <tbody>
                @foreach($fees as $fee)
                  <tr>
                    ...
                    <td><button data-toggle="modal" data-target="#Edit_Modal" id="fee_edit" type="button" value="{{$fee->id}}"><i class="fas fa-key">&nbsp;</i></button></td>
                    <td><button data-toggle="modal" data-target="#delete_modal" id="fee_delete" type="button" value="{{$fee->id}}"><i class="fa fa-trash">&nbsp;</i></button></td>
                  </tr>
                @endforeach
              </tbody>
              <tfoot>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    //$('#on_submit_save').click(function(){
                        ...
                        success: function(results)
                        {
                            ...
                            if(results.data){
                              $.each(results.data, function( i, val ) {
                                var markup = "<tr><td>" +val.name + "</td><td>" + val.type + "</td><td>" + val.created_at + "</td><td>" + val.value + "</td><td><button data-toggle='modal' data-target='#Edit_Modal' id='fee_edit' type='button' value='"+val.id+"'><i class='fas fa-key'>&nbsp;</i></button></td><td><button data-toggle='modal' data-target='#delete_modal' id='fee_delete' type='button' value='"+val.id+"'><i class='fa fa-trash'>&nbsp;</i></button></td></tr>";
      ...
      $('#on_submit_save_fee').click(function(){
