    ...
    <!-- Delete Modal -->
            ...
            <!-- Delete Modal Ends -->
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" style="text-align: right;">
                  <a href="#" data-toggle="modal" data-target="#delete_modal"><i class="fa fa-trash"><span >Delete invoice</span></i></a>
                </div>

    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <div class="events">
        @include('admin.layouts.invoice_details.summary_invoice')
      </div>
    </div>

    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <div class="events">
        @include('admin.layouts.invoice_details.invoicedetails_invoice')
      </div>
    </div>
