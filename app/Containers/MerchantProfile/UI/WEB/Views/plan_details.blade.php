    ...
    <!-- Delete Modal -->
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p>Are you sure you want to delete this plan? This can't be undone. Existing subscriptions wont be affected.</p>
                  </div>
            ...
            <!-- Delete Modal Ends -->
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" style="text-align: right;">
                  <a href="#" data-toggle="modal" data-target="#delete_modal"><i class="fa fa-trash"><span >Delete plan</span></i></a>
                </div>

    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <div class="events">
        @include('admin.layouts.plan_details.details_plan')
      </div>
    </div>
