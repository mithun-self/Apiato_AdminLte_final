				...
				<div class="row">
					<div class="col-md-6">
						<ul class="list-group">
						    ...
						    <li class="list-group-item"><span class="title">Subscription</span></li>
					  	</ul>
					 </div>
					 <div class="col-md-6">
						<ul class="list-group">
						    <li class="list-group-item"><span class="inv_id"></span></li>
						    <li class="list-group-item"><span class="inv_created"></span></li>
						    <li class="list-group-item"><span class="inv_cust"></span></li>
						    <li class="list-group-item"><span class="inv_subs"></span></li>
					  	</ul>
					 </div>
			  	</div>
			</div>
  ...
  ({
    ...
    success: function(data)
    {
      $.each(data, function(key, value) {
      	console.log(value);
            $('span.inv_id').html(this.id);
            $('span.inv_created').html(this.customer.data.email+'<br>( '+this.customer.data.name+' )');
            $('span.inv_cust').html(this.created_at.date);
           $('span.inv_subs').html(this.subscriptions.data.plan.data.name);
