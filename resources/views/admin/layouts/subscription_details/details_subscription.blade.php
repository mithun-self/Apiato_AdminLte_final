		...
		<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-6">
						<ul class="list-group">
						    ...
						    <li class="list-group-item"><span>Current period</span></li>
						    <li class="list-group-item"><span>Customer</span></li>
					  	</ul>
					 </div>
					 <div class="col-md-6">
						<ul class="list-group">
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-6">
						<ul class="list-group">
					    	<li class="list-group-item"><span>Tax percent</span></li>
					    	<li class="list-group-item"><span>Discount</span></li>
					    	<li class="list-group-item"><span>Billing method</span></li>
						</ul>
					</div>
					<div class="col-md-6">
						<ul class="list-group">
					    	<li class="list-group-item">----</li>
					    	<li class="list-group-item">zADl1YM11gYg5MjW</li>
					    	<li class="list-group-item">Charge payment source on file</li>
						</ul>
					</div>
				</div>
			</div>
