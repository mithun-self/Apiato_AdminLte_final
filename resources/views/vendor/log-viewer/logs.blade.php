            ...
            <tbody>
                @if ($rows->count() > 0)
                    ...
                    <tr>
                        ...
                        @endforeach
                        <td class="text-right">
                            <a title="view" href="{{ route('log-viewer::logs.show', [$date]) }}" class="btn btn-xs btn-info">
                                <i class="fa fa-search"></i>
                            </a>
                            <a title="download" href="{{ route('log-viewer::logs.download', [$date]) }}" class="btn btn-xs btn-success">
                                <i class="fa fa-download"></i>
                            </a>
                            <a title="delete" href="#delete-log-modal" id="delete-log-modal_button" class="btn btn-xs btn-danger" data-log-date="{{ $date }}">
...
@section('js')
    <script>
        $(function () {
            ...
            $(document).on('click', '#delete-log-modal_button', function(event){ 
