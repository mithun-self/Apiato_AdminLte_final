            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="group-btns pull-right">
                        <button class="btn btn-xs" onclick="goBack()"><i class="fas fa-caret-left">Back</i></button>
                        ...
                        <tbody>
                            @forelse($entries as $key => $entry)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        @if ($entry->hasStack())
                                            <a class="btn btn-xs btn-default" style="color: #333;" role="button" data-toggle="collapse" href="#log-stack-{{ $key }}" aria-expanded="false" aria-controls="log-stack-{{ $key }}">
